...
urlpatterns = [
    ...
    path('api/engagements/get_opportunity_engagements/<uuid:volunteer_opportunity_id>/', get_opportunity_engagements, name='get_opportunity_engagements'), # done - doesnt need event listener - called when opening modal prior to completing an opportunity
    path('api/engagements/complete_engagements_organization/<uuid:volunteer_opportunity_id>/', complete_engagements_organization, name='complete_engagements_organization'), # needs event listener - to call together with complete_opportunity and create_opportunity_engagement_logs
    ...
    path('api/sessions/cancel_session/<uuid:session_id>/', cancel_session, name='cancel_session'), # done - needs event listener - DONE
