...
urlpatterns = [
    ...
    path('api/volunteer_matching_preferences/get_volunteer_preferences/', get_volunteer_preferences, name='get_volunteer_preferences'),
    path('api/volunteer_matching_preferences/update_volunteer_preferences/', update_volunteer_preferences, name='update_volunteer_preferences'),
