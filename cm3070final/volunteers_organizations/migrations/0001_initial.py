# Generated by Django 5.1.4 on 2025-01-28 15:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_address', models.JSONField(default=list)),
                ('organization_website', models.URLField(blank=True, null=True)),
                ('organization_profile_img', models.ImageField(blank=True, null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_duration', models.JSONField(blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('volunteer', 'organization'), name='unique_volunteer_per_organization'), models.UniqueConstraint(condition=models.Q(('role', 'admin')), fields=('organization', 'role'), name='unique_admin_per_organization'), models.CheckConstraint(condition=models.Q(('role__in', ['admin', 'opportunity leader', 'member'])), name='valid_role_check')],
            },
        ),
        migrations.CreateModel(
            name='Following',
